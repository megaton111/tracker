<template>
  <div class="flex flex-col gap-1">
    <div class="flex gap-2">
      <div class="inline-flex items-center font-bold">구매가격</div>
      <div class="inline-flex flex-1"><t-input type="text" placeholder="가격을 입력하세요." v-model="buyPrice"></t-input></div>
      <div class="inline-flex items-center">원</div>
    </div>
    <div class="flex gap-2">
      <div class="inline-flex items-center font-bold">판매가격</div>
    ...
    <div class="flex gap-2" v-if="!isNaN(marginRate)&&marginRate>0">
      <div class="inline-flex items-center font-bold">마진율</div>
