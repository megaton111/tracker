<template>
  ...
  <div class="flex flex-col gap-10">
    ...
    <div class="flex flex-col gap-10">
      ...
      <div class="flex flex-1 flex-col gap-2" v-if="selectTab.value == '01'">
        <div class="flex flex-row w-full gap-4">
          <div class="flex flex-1 flex-col gap-2">
            <div class="text-base font-bold text-lg">수취인</div>
            <div class="flex flex-col">
              <textarea 
                rows="5" 
                v-model="nameList" 
          ...
          <div class="flex flex-1 flex-col gap-2">
            <div class="text-base font-bold text-lg">개인통관고유번호</div>
            <div class="flex flex-col">
              <textarea 
                rows="5" 
                v-model="numberList" 
          ...
          <div class="flex flex-1 flex-col gap-2">
            <div class="text-base font-bold text-lg">수취인 전화번호</div>
            <div class="flex flex-col">
              <textarea 
                rows="5" 
                v-model="telList" 
      ...
      <div class="flex flex-1 flex-col gap-6" v-else>
        <div class="flex flex-col gap-4">
