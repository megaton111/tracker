  ...
  <div class="flex flex-col gap-5 sm:gap-10">
    ...
    <div class="flex flex-col gap-4">
      <div class="flex flex-col">
        <RadioGroup v-model="selectTab">
          <RadioGroupLabel class="sr-only">계산기를 선택하세요.</RadioGroupLabel>
    ...
    <div class="flex flex-col gap-4 sm:gap-6" v-else-if="selectTab.value == '02'">
      <div class="flex flex-col gap-2 sm:gap-4">
        <div class="flex gap-2">
          <div class="flex items-center w-24"><div class="text-style-section-head">판매가</div></div>
    ...
    <div class="flex flex-col gap-4 sm:gap-6" v-else-if="selectTab.value == '03'">
      <CalculatorCoupangAd />
    </div>
...
<script>
  ...
  import CalculatorCoupangAd from './calculator_coupang_ad.vue';
  ...
  export default {
    ...
    setup () {
      ...
      // 탭 리스트
      const tabList = [
        { name: '일반판매 마진계산기', value: '01' },
        { name: '로켓그로스 마진계산기', value: '02' },
        { name: '최소광고수익율', value: '03' },
      ] ;
